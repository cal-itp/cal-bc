    ...
    highway_subsections_build = [
        {
            ...
            'widgets': [HOV_Vol_year1peak_build_widgets, Non_HOV_Vol_year1peak_build_widgets, Weaving_Vol_year1peak_build_widgets ],
            'info_texts': highway_speed_and_volume_input_build_info[1:4]
        }
    ]
