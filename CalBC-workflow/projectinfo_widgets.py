# This script generates interactive widgets that replicate the "Project Info" sheet from the CalBC Sketch Model. 

# Importing necessary libraries for creating interactive widgets
...
# Importing various project-related titles, subtitles, and information sections from the 'widgets_helper' module to be used for displaying project data.
# These include sections for highway design, pavement condition, traffic data, crash statistics, rail and transit data, and more.
from widgets_helper import (
    info_button_popup, create_section, project_info_title, project_info_subtitle, project_info_info,
...
####################################################### 1A. Project Data #######################################################
    ...
    one_two_way_widget = widgets.Dropdown(
        options=[('One-Way', 1), ('Two-Way', 2)],
        value=2,  # Default value is Two-Way (2)
        description='One- or Two-Way Data: ',
        disabled=False,
        layout=common_layout,  
        style={'description_width': 'initial'}  
    )
...
################################### 1B. Highway Design and Traffic Data ##########################################
    ...
    def update_roadway_type(change):
        ...
        if subcategory == "Hwy-Rail Grade Crossing":
            roadway_type_no_build_widget.value = "C"  
            roadway_type_build_widget.value = "C"  
        else:
            roadway_type_no_build_widget.value = "F"  
            roadway_type_build_widget.value = "F" 
